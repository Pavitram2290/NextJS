...
export default function Associations_Section() {
    return (
        <>
            <section className="section background-grey spdtb">
                <div className="container">
                    <div className="heading align-center">
                        <h2 className="heading-title size-xl">Associations of our tutors</h2>
                    </div>
                    <div className="row flex-align-c">
                        <div className="col-lg-3 col-6 align-center pb30">
